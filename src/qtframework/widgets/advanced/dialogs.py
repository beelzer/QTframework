...
class InputDialog(QDialog):
    ...
    def __init__(
        ...
        translation_key_title: str | None = None,
        translation_key_label: str | None = None,
    ) -> None:
...
class ConfirmDialog(QDialog):
    ...
    def __init__(
        ...
        parent: QWidget | None = None,
        translation_key_title: str | None = None,
        translation_key_message: str | None = None,
        **kwargs,
    ) -> None:
...
def show_error_dialog(
    ...
    **kwargs,
    ...
    title_text = title or t(translation_key_title)
    message_text = message or t(translation_key_message, **kwargs)
